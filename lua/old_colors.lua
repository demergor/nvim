local function my_colors()
  ...
  vim.api.nvim_set_hl(0, "Statement",         { fg = "#e1e5e2", bold = true })
  ...
  vim.api.nvim_set_hl(0, "Type",              { fg = "#ff7739", bold = false })
  ...
  -- Color column
  vim.api.nvim_set_hl(0, "ColorColumn",       { bg = "#390000" })
  ...
  -- netrw
  vim.api.nvim_set_hl(0, "Directory",         { fg = "#e1e5e2", bold = true })
end
